                    ...
                    <div class="container-fluid">
                        ...
                        <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                            <ul class="nav navbar-nav navbar-right">
                                ...
                                <li><button class="btn" data-toggle="modal" data-target="#addimg">Add Coupan</button> </li>
                                ...
                                if($result->num_rows > 0){
                                     while($row = $result->fetch_assoc()) 
                                    {
                                        ...
                                        echo "
                                            ...
                                            <td>
                                                    <form action='coupan.php' method='post'>
                                                        <button type='submit' value='".$row['id']."' name='delete' class='btn btn-primary' data-toggle='modal' data-target='#deleteimg'>Delete</button>         
                                                    </form>
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <form method="POST" action="coupandata.php" enctype="multipart/form-data">
                          <div>
                             Coupan Code:<input class="form-control" type="text" name="coupan"> 
                          </div>
                           <div>
 ...
 $conn = new mysqli('localhost', 'root', '','pharma');
        ...
        else
        {
            if (isset($_POST['delete'])) 
            {
                ...
                $sql = "DELETE FROM coupan WHERE id='$id' ";
