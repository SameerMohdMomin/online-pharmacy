                    ...
                    <div class="container-fluid">
                        ...
                        <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                            <ul class="nav navbar-nav navbar-right">
                                ...
                                <li><button class="btn" data-toggle="modal" data-target="#addimg">Add Brand</button> </li>
                                        ...
                                        echo "
                                            ...
                                            <td>
                                                    <form action='brand.php' method='post'>
                                                        <button type='submit' value='".$row['brand_id']."' name='delete' class='btn btn-primary' data-toggle='modal' data-target='#deleteimg'>Delete</button>         
                                                    </form>
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <form method="POST" action="branddata.php" enctype="multipart/form-data">
                          <div>
                             Brand Name:<input class="form-control" type="text" name="name"> 
                          </div>
